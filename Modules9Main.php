...
<header>
    ...
    <div class="content-wrapper">
        ...
        <a href="Modules8Main.php" class="back-button" onclick="markModuleAsDone(9)">Back</a>
        <a href="module10Main.php" class="next-button" onclick="markModuleAsDone(9)">Next</a>
